 ...
 * Use the {@link ContactAdmin#newInstance} factory method to
...
public class ContactAdmin extends Fragment {
    ...
    public static ContactAdmin newInstance(String param1, String param2) {
        ContactAdmin fragment = new ContactAdmin();
